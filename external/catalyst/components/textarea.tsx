// Catalyst-style Textarea — recreated from the scraped API at
// https://catalyst.tailwindui.com/docs/textarea
...
export const Textarea = forwardRef(function Textarea({ className, resizable = true, ...props }: TextareaProps, ref: React.ForwardedRef<HTMLTextAreaElement>) {
  return (
