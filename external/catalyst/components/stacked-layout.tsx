// Catalyst-style StackedLayout — recreated from https://catalyst.tailwindui.com/docs/stacked-layout
...
export function StackedLayout({ navbar, sidebar, children }: { navbar: React.ReactNode; sidebar: React.ReactNode; children: React.ReactNode }) {
  const [open, setOpen] = useState(false)
  return (
    <div className="relative isolate flex min-h-dvh w-full flex-col bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
