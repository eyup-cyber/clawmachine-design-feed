// Catalyst-style Dialog + DialogTitle + DialogDescription + DialogBody + DialogActions —
// recreated from https://catalyst.tailwindui.com/docs/dialog
...
const sizes = {
  xs: 'sm:max-w-xs', sm: 'sm:max-w-sm', md: 'sm:max-w-md', lg: 'sm:max-w-lg', xl: 'sm:max-w-xl',
  '2xl': 'sm:max-w-2xl', '3xl': 'sm:max-w-3xl', '4xl': 'sm:max-w-4xl', '5xl': 'sm:max-w-5xl',
}
type Size = keyof typeof sizes

export function Dialog({ size = 'lg', className, children, ...props }: { size?: Size; className?: string; children: React.ReactNode } & Omit<Headless.DialogProps, 'as' | 'className'>) {
  return (
...
export function DialogTitle({ className, ...props }: Omit<Headless.DialogTitleProps, 'className'> & { className?: string }) {
...
export function DialogDescription({ className, ...props }: Omit<Headless.DescriptionProps, 'as' | 'className'> & { className?: string }) {
