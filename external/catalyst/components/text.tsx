// Catalyst-style Text / TextLink / Strong / Code — recreated from the scraped
// API at https://catalyst.tailwindui.com/docs/text
...
export function Strong({ className, ...props }: React.HTMLAttributes<HTMLElement>) {
